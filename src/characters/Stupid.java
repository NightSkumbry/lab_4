...
public class Stupid extends InventoryCharacter implements ICanSpeak {
    public Stupid(String name_1, String name_2, States state) {
        super(name_1, name_2, state);
    }

    public Stupid(String name, States state) {
        this(name, name, state);
    }

    public Stupid(String name_1, String name_2, States state, ArrayList<Item> inventory) {
        super(name_1, name_2, state, inventory);
    }

    public Stupid(String name, States state, ArrayList<Item> inventory) {
